(function () {
  ...
  function renderLiveDetail(st) {
    ...
    document.getElementById("ld-spread").textContent = spread != null
      ? (spread >= 3 ? "⚠ modelo y empírico difieren ±" + spread.toFixed(1) + "° — baja confianza" : "modelo y empírico de acuerdo (±" + spread.toFixed(1) + "°)")
      : "";
    ...
    if (mb) {
      const CONF_LABEL = { escalable: "✅ escalable", moderado: "🟡 moderado", cautela: "🔶 cautela (precio bajo)" };
