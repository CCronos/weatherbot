...
Automated weather market trading bot for Polymarket. Finds mispriced temperature outcomes using real forecast data from multiple sources across 22 cities worldwide.
...
- **22 cities** across 4 continents (US, Europe, Asia, South America, Oceania)
